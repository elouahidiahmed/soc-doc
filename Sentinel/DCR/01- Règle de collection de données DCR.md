...
style DCRAs color:#fff,fill:#3350aa,stroke:#fff,stroke-width:1px

style Ressource color:#333, fill:#fff, stroke:#fff
style DCRA     color:#333, fill:#fff, stroke:#fff
style DCR      color:#333, fill:#fff, stroke:#fff
